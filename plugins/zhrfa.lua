...
redis:setex(SAKE..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_,500,true)
...
if msg.text and msg.type ~= "pv" and redis:get(SAKE..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_) then
redis:del(SAKE..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_)
