...
download_file('https://raw.githubusercontent.com/sakebots/SAKE/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/sakebots/SAKE/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/sakebots/SAKE/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/sakebots/SAKE/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(SAKE..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(SAKE..":NameBot:") or "ساكي"
...
local Fshar_Word , res = https.request('https://api.th3SAKE.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3SAKE.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = redis:get(SAKE..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(SAKE..':SUDO_BOT:',UserID) then
var = redis:get(SAKE..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(SAKE..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(SAKE..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(SAKE..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(SAKE..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(SAKE..'owners:'..ChatID,UserID) then
var = redis:get(SAKE..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(SAKE..'admins:'..ChatID,UserID) then
var = redis:get(SAKE..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(SAKE..'whitelist:'..ChatID,UserID) then
var = redis:get(SAKE..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(SAKE..':NameBot:'))
...
if msg.edited then
redis:incr(SAKE..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(SAKE..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(SAKE..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(SAKE..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(SAKE..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(SAKE..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(SAKE..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(SAKE..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(SAKE..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(SAKE..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(SAKE..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(SAKE..'owners:'..msg.chat_id_)
local Admins = redis:smembers(SAKE..'admins:'..msg.chat_id_)
local mmez = redis:smembers(SAKE..'whitelist:'..msg.chat_id_)
...
local list = redis:smembers(SAKE..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(SAKE..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(SAKE..'username:'..v)
local count = redis:scard(SAKE..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
local list = redis:smembers(SAKE..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(SAKE..'admins:'..msg.chat_id_)
...
local list = redis:smembers(SAKE..'whitelist:'..msg.chat_id_)
...
if redis:sismember(SAKE..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(SAKE..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(SAKE..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(SAKE..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(SAKE..'gban_users')
...
local list = redis:smembers(SAKE..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(SAKE..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(SAKE..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(SAKE..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(SAKE..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(SAKE..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(SAKE..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..SAKE..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(SAKE..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(SAKE..'group:name'..GroupS) or '')
...
local admins = redis:smembers(SAKE..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(SAKE..'username:'..value)
if info then 
...
local creator = redis:smembers(SAKE..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(SAKE..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(SAKE..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(SAKE..'group:name'..v)
if info then 
...
redis:del(
SAKE..'group:add'..id_group,
SAKE..'lock_link'..id_group, 
SAKE..'lock_id'..id_group,
SAKE..'lock_spam'..id_group, 
SAKE..'lock_webpage'..id_group,
SAKE..'lock_markdown'..id_group,
SAKE..'lock_flood'..id_group,
SAKE..'lock_bots'..id_group,
SAKE..'mute_forward'..id_group,
SAKE..'mute_contact'..id_group,
SAKE..'mute_location'..id_group,
SAKE..'mute_document'..id_group,
SAKE..'mute_keyboard'..id_group,
SAKE..'mute_game'..id_group,
SAKE..'mute_inline'..id_group,
SAKE..'lock_username'..id_group,
SAKE..'num_msg_max'..id_group,
SAKE..'mute_text'..id_group,
SAKE..'admins:'..id_group,
SAKE..':Filter_Word:'..id_group,
SAKE..'banned:'..id_group,
SAKE..'is_silent_users:'..id_group,
SAKE..'whitelist:'..id_group,
SAKE..':MONSHA_BOT:'..id_group,
SAKE..'owners:'..id_group,
SAKE..'replay'..id_group,
SAKE..':MONSHA_Group:'..id_group
)
redis:srem(SAKE..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(SAKE..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(SAKE..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(SAKE..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(SAKE..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n📮¦ بواسطه ⋙「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(SAKE..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(SAKE..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(SAKE..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
SAKE..'group:add'..arg.chat_id_,true,
SAKE..'lock_link'..arg.chat_id_,true, 
SAKE..'lock_id'..arg.chat_id_,true,
SAKE..'lock_spam'..arg.chat_id_,true,
SAKE..'lock_webpage'..arg.chat_id_,true,
SAKE..'lock_markdown'..arg.chat_id_,true,
SAKE..'lock_flood'..arg.chat_id_,true,
SAKE..'lock_bots'..arg.chat_id_,true,
SAKE..'mute_forward'..arg.chat_id_,true,
SAKE..'mute_contact'..arg.chat_id_,true,
SAKE..'mute_location'..arg.chat_id_,true,
SAKE..'mute_document'..arg.chat_id_,true,
SAKE..'mute_keyboard'..arg.chat_id_,true,
SAKE..'mute_game'..arg.chat_id_,true,
SAKE..'mute_inline'..arg.chat_id_,true,
SAKE..'lock_username'..arg.chat_id_,true,
SAKE..'num_msg_max'..arg.chat_id_,5, 
SAKE..'lock_edit'..arg.chat_id_,true,
SAKE..'replay'..arg.chat_id_,true,
SAKE..'lock_rdodSource'..arg.chat_id_,true,
SAKE.."lock_KickBan"..msg.chat_id_,true,
SAKE.."lock_mmno3"..msg.chat_id_,true,
SAKE.."lock_KickBan"..msg.chat_id_,true,
SAKE.."lock_RandomRdod"..msg.chat_id_,true,
SAKE.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(SAKE..'group:ids',arg.chat_id_) 
redis:sadd(SAKE..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(SAKE..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(SAKE..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(SAKE..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(SAKE..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(SAKE..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(SAKE..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(SAKE..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(SAKE..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(SAKE..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(SAKE..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(SAKE..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(SAKE..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(SAKE..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(SAKE..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(SAKE..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(SAKE..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(SAKE..'username:'..UserID,'username',USERNAME)
redis:sadd(SAKE..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(SAKE..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(SAKE..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..'banned:'..ChatID,UserID)
...
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:srem(SAKE..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:sadd(SAKE..'is_silent_users:'..ChatID,UserID)
...
redis:hset(SAKE..'username:'..UserID, 'username', Resolv)
redis:srem(SAKE..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(SAKE..'username:'..UserID,'username',Resolv)
redis:setex(SAKE..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(SAKE..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(SAKE..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(SAKE..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(SAKE..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(SAKE..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(SAKE..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(SAKE..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(SAKE..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(SAKE..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(SAKE..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(SAKE..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(SAKE..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(SAKE..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(SAKE..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(SAKE..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(SAKE..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(SAKE..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(SAKE..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(SAKE..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(SAKE..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(SAKE..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(SAKE..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(SAKE..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(SAKE..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(SAKE..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(SAKE..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(SAKE..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(SAKE..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(SAKE..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(SAKE..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(SAKE..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(SAKE..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(SAKE..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(SAKE..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(SAKE..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(SAKE..'replay'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود العشوائيه » "..(redis:get(SAKE.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(SAKE..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(SAKE..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(SAKE..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(SAKE..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(SAKE..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(SAKE..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(SAKE..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(SAKE..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(SAKE.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(SAKE.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(SAKE.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(SAKE..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(SAKE..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(SAKE..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(SAKE..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(SAKE..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(SAKE..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(SAKE..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(SAKE..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(SAKE..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
